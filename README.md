# Full Stack JavaScript Project 2

For this project, we had to turn an object array into a fully functional page with a search filter.
...
## Outcome
The page has a background that changes gradient automatically and successfully shows the entire object array on the page. The filter also works correctly and ensures what you are typing in the search box appears on the page. Furthermore, a message appears on the screen if there are no students with the name you are searching for.
